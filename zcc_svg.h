...
void svg_set_d(ZccSvgNode* node, const char* val);
...
void svg_set_r(ZccSvgNode* node, const char* val);
...
void svg_set_x(ZccSvgNode* node, const char* val);
...
void svg_set_y(ZccSvgNode* node, const char* val);
