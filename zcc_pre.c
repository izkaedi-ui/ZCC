...
# 12 "zcc_ast_bridge.h" 2
# 21 "zcc_ast_bridge.h"
# 1 "zcc_ast_bridge_constants.h" 1
# 22 "zcc_ast_bridge.h" 2
...
struct Node *node_init(struct Node *n);
struct Node *node_inc(struct Node *n);
struct Node **node_cases(struct Node *n);
int node_num_cases(struct Node *n);
struct Node *node_default_case(struct Node *n);
long long node_case_val(struct Node *n);
struct Node *node_case_body(struct Node *n);
int node_member_offset(struct Node *n);
...
int node_compound_op(struct Node *n);
...
int node_line_no(struct Node *n);
...
enum {
    ...
    ZND_TERNARY,
    ZND_SIZEOF,
    ZND_POST_DEC, ZND_PRE_INC, ZND_PRE_DEC,
    ZND_ASM = 58,
    ZND_VLA_ALLOC = 59,
    ZND_GOTO = 60,
    ZND_LABEL = 61
...
struct PassResult {
    unsigned int order[2048];
    char block_names[2048][64];
...
void zcc_set_use_profile(const char *path);
...
struct WireInitNode {
    ...
    union {
        struct { uint32_t child_count; } list;
...
# 1 "zcc_ast_bridge_asserts.inc" 1

typedef char zcc_static_assert_ND_NUM[ (ND_NUM == 1) ? 1 : -1 ];
typedef char zcc_static_assert_ND_STR[ (ND_STR == 2) ? 1 : -1 ];
typedef char zcc_static_assert_ND_CHAR_LIT[ (ND_CHAR_LIT == 3) ? 1 : -1 ];
typedef char zcc_static_assert_ND_FLIT[ (ND_FLIT == 4) ? 1 : -1 ];
typedef char zcc_static_assert_ND_VAR[ (ND_VAR == 5) ? 1 : -1 ];
typedef char zcc_static_assert_ND_ASSIGN[ (ND_ASSIGN == 6) ? 1 : -1 ];
typedef char zcc_static_assert_ND_ADD[ (ND_ADD == 7) ? 1 : -1 ];
typedef char zcc_static_assert_ND_SUB[ (ND_SUB == 8) ? 1 : -1 ];
typedef char zcc_static_assert_ND_MUL[ (ND_MUL == 9) ? 1 : -1 ];
typedef char zcc_static_assert_ND_DIV[ (ND_DIV == 10) ? 1 : -1 ];
typedef char zcc_static_assert_ND_MOD[ (ND_MOD == 11) ? 1 : -1 ];
typedef char zcc_static_assert_ND_EQ[ (ND_EQ == 12) ? 1 : -1 ];
typedef char zcc_static_assert_ND_NE[ (ND_NE == 13) ? 1 : -1 ];
typedef char zcc_static_assert_ND_LT[ (ND_LT == 14) ? 1 : -1 ];
typedef char zcc_static_assert_ND_LE[ (ND_LE == 15) ? 1 : -1 ];
typedef char zcc_static_assert_ND_GT[ (ND_GT == 16) ? 1 : -1 ];
typedef char zcc_static_assert_ND_GE[ (ND_GE == 17) ? 1 : -1 ];
typedef char zcc_static_assert_ND_LAND[ (ND_LAND == 18) ? 1 : -1 ];
typedef char zcc_static_assert_ND_LOR[ (ND_LOR == 19) ? 1 : -1 ];
typedef char zcc_static_assert_ND_LNOT[ (ND_LNOT == 20) ? 1 : -1 ];
typedef char zcc_static_assert_ND_BAND[ (ND_BAND == 21) ? 1 : -1 ];
typedef char zcc_static_assert_ND_BOR[ (ND_BOR == 22) ? 1 : -1 ];
typedef char zcc_static_assert_ND_BXOR[ (ND_BXOR == 23) ? 1 : -1 ];
typedef char zcc_static_assert_ND_BNOT[ (ND_BNOT == 24) ? 1 : -1 ];
typedef char zcc_static_assert_ND_SHL[ (ND_SHL == 25) ? 1 : -1 ];
typedef char zcc_static_assert_ND_SHR[ (ND_SHR == 26) ? 1 : -1 ];
typedef char zcc_static_assert_ND_FADD[ (ND_FADD == 27) ? 1 : -1 ];
typedef char zcc_static_assert_ND_FSUB[ (ND_FSUB == 28) ? 1 : -1 ];
typedef char zcc_static_assert_ND_FMUL[ (ND_FMUL == 29) ? 1 : -1 ];
typedef char zcc_static_assert_ND_FDIV[ (ND_FDIV == 30) ? 1 : -1 ];
typedef char zcc_static_assert_ND_NEG[ (ND_NEG == 31) ? 1 : -1 ];
typedef char zcc_static_assert_ND_ADDR[ (ND_ADDR == 32) ? 1 : -1 ];
typedef char zcc_static_assert_ND_DEREF[ (ND_DEREF == 33) ? 1 : -1 ];
typedef char zcc_static_assert_ND_CALL[ (ND_CALL == 34) ? 1 : -1 ];
typedef char zcc_static_assert_ND_RETURN[ (ND_RETURN == 35) ? 1 : -1 ];
typedef char zcc_static_assert_ND_BLOCK[ (ND_BLOCK == 36) ? 1 : -1 ];
typedef char zcc_static_assert_ND_IF[ (ND_IF == 37) ? 1 : -1 ];
typedef char zcc_static_assert_ND_WHILE[ (ND_WHILE == 38) ? 1 : -1 ];
typedef char zcc_static_assert_ND_FOR[ (ND_FOR == 39) ? 1 : -1 ];
typedef char zcc_static_assert_ND_DO_WHILE[ (ND_DO_WHILE == 40) ? 1 : -1 ];
typedef char zcc_static_assert_ND_BREAK[ (ND_BREAK == 41) ? 1 : -1 ];
typedef char zcc_static_assert_ND_CONTINUE[ (ND_CONTINUE == 42) ? 1 : -1 ];
typedef char zcc_static_assert_ND_GOTO[ (ND_GOTO == 43) ? 1 : -1 ];
typedef char zcc_static_assert_ND_GOTO_COMPUTED[ (ND_GOTO_COMPUTED == 44) ? 1 : -1 ];
typedef char zcc_static_assert_ND_LABEL[ (ND_LABEL == 45) ? 1 : -1 ];
typedef char zcc_static_assert_ND_SWITCH[ (ND_SWITCH == 46) ? 1 : -1 ];
typedef char zcc_static_assert_ND_CASE[ (ND_CASE == 47) ? 1 : -1 ];
typedef char zcc_static_assert_ND_DEFAULT[ (ND_DEFAULT == 48) ? 1 : -1 ];
typedef char zcc_static_assert_ND_CAST[ (ND_CAST == 49) ? 1 : -1 ];
typedef char zcc_static_assert_ND_SIZEOF[ (ND_SIZEOF == 50) ? 1 : -1 ];
typedef char zcc_static_assert_ND_VA_ARG[ (ND_VA_ARG == 51) ? 1 : -1 ];
typedef char zcc_static_assert_ND_ADDR_LABEL[ (ND_ADDR_LABEL == 52) ? 1 : -1 ];
typedef char zcc_static_assert_ND_MEMBER[ (ND_MEMBER == 53) ? 1 : -1 ];
typedef char zcc_static_assert_ND_PRE_INC[ (ND_PRE_INC == 54) ? 1 : -1 ];
typedef char zcc_static_assert_ND_PRE_DEC[ (ND_PRE_DEC == 55) ? 1 : -1 ];
typedef char zcc_static_assert_ND_POST_INC[ (ND_POST_INC == 56) ? 1 : -1 ];
typedef char zcc_static_assert_ND_POST_DEC[ (ND_POST_DEC == 57) ? 1 : -1 ];
typedef char zcc_static_assert_ND_TERNARY[ (ND_TERNARY == 58) ? 1 : -1 ];
typedef char zcc_static_assert_ND_COMMA_EXPR[ (ND_COMMA_EXPR == 59) ? 1 : -1 ];
typedef char zcc_static_assert_ND_FUNC_DEF[ (ND_FUNC_DEF == 60) ? 1 : -1 ];
typedef char zcc_static_assert_ND_GLOBAL_VAR[ (ND_GLOBAL_VAR == 61) ? 1 : -1 ];
typedef char zcc_static_assert_ND_COMPOUND_ASSIGN[ (ND_COMPOUND_ASSIGN == 62) ? 1 : -1 ];
typedef char zcc_static_assert_ND_INIT_LIST[ (ND_INIT_LIST == 63) ? 1 : -1 ];
typedef char zcc_static_assert_ND_ASM[ (ND_ASM == 64) ? 1 : -1 ];
typedef char zcc_static_assert_ND_NOP[ (ND_NOP == 65) ? 1 : -1 ];
# 314 "zcc.c" 2
...
struct Node *node_lhs(struct Node *n) { return n ? n->lhs : 
# 339 "zcc.c" 3 4
                                                           ((void *)0)
# 339 "zcc.c"
                                                               ; }
struct Node *node_rhs(struct Node *n) { return n ? n->rhs : 
# 340 "zcc.c" 3 4
                                                           ((void *)0)
# 340 "zcc.c"
                                                               ; }
struct Node *node_cond(struct Node *n) { return n ? n->cond : 
# 341 "zcc.c" 3 4
                                                             ((void *)0)
# 341 "zcc.c"
                                                                 ; }
struct Node *node_then_body(struct Node *n) { return n ? n->then_body : 
# 342 "zcc.c" 3 4
                                                                       ((void *)0)
# 342 "zcc.c"
                                                                           ; }
struct Node *node_else_body(struct Node *n) { return n ? n->else_body : 
# 343 "zcc.c" 3 4
                                                                       ((void *)0)
# 343 "zcc.c"
                                                                           ; }
struct Node *node_body(struct Node *n) { return n ? n->body : 
# 344 "zcc.c" 3 4
                                                             ((void *)0)
# 344 "zcc.c"
                                                                 ; }
struct Node *node_init(struct Node *n) { return n ? n->init : 
# 345 "zcc.c" 3 4
                                                             ((void *)0)
# 345 "zcc.c"
                                                                 ; }
struct Node *node_inc(struct Node *n) { return n ? n->inc : 
# 346 "zcc.c" 3 4
                                                           ((void *)0)
# 346 "zcc.c"
                                                               ; }
int node_compound_op(struct Node *n) { return n ? n->compound_op : 0; }
struct Node **node_stmts(struct Node *n) { return n ? n->stmts : 
# 348 "zcc.c" 3 4
                                                                ((void *)0)
# 348 "zcc.c"
                                                                    ; }
...
struct Node *node_arg(struct Node *n, int i) {
    if (!n || !n->args || i < 0 || i >= n->num_args) return 
# 373 "zcc.c" 3 4
                                                           ((void *)0)
# 373 "zcc.c"
                                                               ;
...
struct Node **node_cases(struct Node *n) { return n ? n->cases : 
# 377 "zcc.c" 3 4
                                                                ((void *)0)
# 377 "zcc.c"
                                                                    ; }
int node_num_cases(struct Node *n) { return n ? n->num_cases : 0; }
struct Node *node_default_case(struct Node *n) { return n ? n->default_case : 
# 379 "zcc.c" 3 4
                                                                             ((void *)0)
# 379 "zcc.c"
                                                                                 ; }
long long node_case_val(struct Node *n) { return n ? (long long)n->case_val : 0; }
struct Node *node_case_body(struct Node *n) { return n ? n->case_body : 
# 381 "zcc.c" 3 4
                                                                       ((void *)0)
# 381 "zcc.c"
                                                                           ; }
...
# 999 "zcc.c" 3 4
               stderr
# 999 "zcc.c"
                     , "zcc preprocessor error: macro expansion too deep\n");
        exit(1);
    }
...
static PPMacro *pp_add_macro(PPState *state, const char *name) {
    PPMacro *m_macro;
    if (state->num_macros >= 8192) return 0;
...
# 1103 "zcc.c" 3 4
                   stderr
# 1103 "zcc.c"
                         , "zcc: macro body exceeds PP_MAX_BODY (%d bytes)\n", max_limit);
            exit(1);
        }
        char c = pp_peek(state);
...
# 1324 "zcc.c" 3 4
           stderr
# 1324 "zcc.c"
                 , "pp_process_include: %s added %d macros, total is %d\n",
    ...
    if (strcmp(dir, "ifdef") == 0 || strcmp(dir, "ifndef") == 0) {
        ...
        if (strcmp(dir, "define") == 0) {
            ...
            if (pp_peek(state) == '(') {
                ...
                pp_skip_whitespace(state);
                pp_read_macro_body(state, m, 65536);
            } else {
                pp_skip_whitespace(state);
                pp_read_macro_body(state, m, 65536);
            }
...
# 1716 "zcc.c" 3 4
                   stderr
# 1716 "zcc.c"
                         , "zcc preprocessor error: #error %s\n", msg);
        } else {
            pp_read_line(state, dir, 1024);
        }
    } else {
...
# 1803 "zcc.c"
    ...
    while (pp_peek(state) != 0) {
        ...
        if (c == '\\') {
            ...
            if (p_count < 128) {
                ...
                if (!_warned_pp_max_params && p_count >= 128) { printf("zcc: warning: PP_MAX_PARAMS (%d) exceeded at %s:%d — subsequent macro args silently discarded\n", 128, state->filename ? state->filename : "?", state->line); _warned_pp_max_params = 1; }
                pp_next(state);
            }
            continue;
        }
    ...
    char *expanded_args[128];
    int expanded_cap[128];
    for (i = 0; i < p_count; i++) {
        expanded_cap[i] = 1024;
...
# 3147 "zcc.c" 3 4
                                       stderr
# 3147 "zcc.c"
                                             , "%s:%d: warning: unknown attribute '%s' ignored [-Wunknown-attributes]\n",
    ...
    if (cc->tk == TK_IDENT) {
        ...
        if (strcmp(cc->tk_text, "yypParser") == 0 || strcmp(cc->tk_text, "pParser") == 0) {
            printf("DEBUG: parse_primary lookup '%s'. sym=%p, sym->type=%p, base=%p, base_tag='%s'\n",
                   cc->tk_text,
                   (void*)sym, sym ? (void*)sym->type : 
# 4392 "zcc.c" 3 4
                                                       ((void *)0)
# 4392 "zcc.c"
                                                           ,
                   (sym && sym->type) ? (void*)sym->type->base : 
# 4393 "zcc.c" 3 4
                                                                ((void *)0)
# 4393 "zcc.c"
                                                                    ,
        ...
        if (cc->tk == TK_DOT) {
            ...
            if (n->type) {
                ...
                if (f) {
                    ...
                    char buf[256];
                    sprintf(buf, "unknown struct member '%s' in struct '%s' (type=%p, fields=%p)", cc->tk_text, (n->type && n->type->tag[0]) ? n->type->tag : "<anon>", (void*)n->type, n->type ? (void*)n->type->fields : 
# 4639 "zcc.c" 3 4
                                                                                                                                                                                                                          ((void *)0)
# 4639 "zcc.c"
                                                                                                                                                                                                                              );
        ...
        if (cc->tk == TK_ARROW) {
            ...
            if (deref->type) {
                ...
                if (f) {
                    ...
                    char buf[256];
                    sprintf(buf, "unknown struct member '%s' after -> in struct '%s' (type=%p, fields=%p)", cc->tk_text, (deref->type && deref->type->tag[0]) ? deref->type->tag : "<anon>", (void*)deref->type, deref->type ? (void*)deref->type->fields : 
# 4684 "zcc.c" 3 4
                                                                                                                                                                                                                                                           ((void *)0)
# 4684 "zcc.c"
                                                                                                                                                                                                                                                               );
...
# 5548 "zcc.c"
                        ;
        if (cc->tk == TK_LBRACE) {
            item = parse_initializer_list(cc, 
# 5550 "zcc.c" 3 4
                                             ((void *)0)
# 5550 "zcc.c"
                                                 );
...
static void emit_local_initializer(Compiler *cc, Node *block, int *cnt, int *cap, Node *base_var, Type *curr_type, Node *init_list, int offset) {
    if (curr_type->kind == TY_ARRAY) {
        ...
        for (int i = 0; i < init_list->num_args && f != 
# 5630 "zcc.c" 3 4
                                                       ((void *)0)
# 5630 "zcc.c"
                                                           ; i++, f = f->next) {
...
Node* zcc_build_from_wire(Compiler *cc, const uint8_t *data, size_t len) {
    if (!data || len < sizeof(WireInitNode)) return 
# 6322 "zcc.c" 3 4
                                                   ((void *)0)
# 6322 "zcc.c"
                                                       ;
...
ShmRingBuffer* zcc_shm_ring_open(void) {
    int fd = shm_open("zcc_ast_ring", 2 , 0);
    if (fd < 0) return 
# 6365 "zcc.c" 3 4
                      ((void *)0)
# 6365 "zcc.c"
                          ;
    ShmRingBuffer* ring = (ShmRingBuffer*)mmap(
# 6366 "zcc.c" 3 4
                                              ((void *)0)
# 6366 "zcc.c"
                                                  , sizeof(ShmRingBuffer),
                                               1 | 2 , 1, fd, 0);
    close(fd);
    return ring;
}
...
# 6378 "zcc.c"
    ...
    size_t slot_size = (16 * 1024 * 1024) / 256;
    size_t offset = (tail % 256) * slot_size;
            ...
            if (cc->tk == TK_ASSIGN) {
                ...
                if (cc->tk == TK_LBRACE) {
                    ...
                    if (init_node && init_node->kind == ND_STR &&
                        gvar->type->kind == TY_ARRAY && gvar->type->array_len == 0) {
                        int slen = cc->strings[init_node->str_id].len + 1;
...
# 6829 "zcc.c"
    ...
    if (root->kind == ZCC_INIT_VALUE) {
        ...
        if (node->num_args > 0) {
            ...
            for (int i = 0; i < root->list.count; i++) {
                node->args[i] = zcc_build_init_internal(cc, root->list.children[i], 
# 6839 "zcc.c" 3 4
                                                                                   ((void *)0)
# 6839 "zcc.c"
                                                                                       );
...
typedef struct ir_node_t {
    ...
    char dst[IR_NAME_MAX];
    char src1[IR_NAME_MAX];
    char src2[IR_NAME_MAX];
    char label[IR_LABEL_MAX];
    char label2[IR_LABEL_MAX];
    ...
    unsigned int vuln_tags;


    int phi_count;
    ir_phi_operand_t *phi_ops;
    int phi_capacity;
...
static char ir_tmp_buf[32];
static char ir_last_result[32];
static int ir_bridge_active;
...
# 7536 "zcc.c"
# 1 "sym_type_ast_ir.h" 1
# 196 "sym_type_ast_ir.h"
...
# 7552 "zcc.c" 3 4
           stderr
# 7552 "zcc.c"
                 , "zcc: sym_type_ast_ir: out of memory (%u bytes)\n", sz);
    exit(1);
  }
  return p;
}
...
# 7635 "zcc.c"
  ...
  sym = (ZccSymbol *)zcc_sym_alloc((unsigned int)sizeof(ZccSymbol));
  strncpy(sym->name, name, 256 - 1);
  sym->name[256 - 1] = '\0';
  sym->kind = kind;
...
# 7732 "zcc.c"
  ...
  while (m) {
    if (strcmp(m->name, name) == 0) {
      ...
      strncpy(scratch.name, name, 256 - 1);
      scratch.kind = 8;
      scratch.ty = m->type;
...
# 7789 "zcc.c" 3 4
             stderr
# 7789 "zcc.c"
                   , "  sym '%s' kind=%d depth=%d offset=%d%s%s\n", s->name,
...
ZccTagTable *tag_table_push(ZccTagTable *parent) {
  ZccTagTable *tt;
  ((void)0);
  tt = (ZccTagTable *)zcc_sym_alloc((unsigned int)sizeof(ZccTagTable));
  tt->parent = parent;
  return tt;
}
...
static ZccTagEntry *tag_define_internal(ZccTagTable *tt, const char *name,
                                        int kind, Type *ty) {
  ZccTagEntry *e;
  unsigned int bucket;
...
ZccTagEntry *tag_define_struct(ZccTagTable *tt, const char *name, Type *ty) {
  ((void)0);
  return tag_define_internal(tt, name, 0, ty);
}

ZccTagEntry *tag_define_union(ZccTagTable *tt, const char *name, Type *ty) {
  ((void)0);
  return tag_define_internal(tt, name, 1, ty);
}

ZccTagEntry *tag_define_enum(ZccTagTable *tt, const char *name, Type *ty) {
  ((void)0);
  return tag_define_internal(tt, name, 2, ty);
}
...
ZccTagEntry *tag_forward_declare(ZccTagTable *tt, const char *name, int kind) {
  ((void)0);
  return tag_define_internal(tt, name, kind, 
# 7938 "zcc.c" 3 4
                                            ((void *)0)
# 7938 "zcc.c"
                                                );
...
Type *type_usual_arith_conv(Type *a, Type *b) {
  ...
  a_unsigned = (a->kind == TY_UCHAR || a->kind == TY_USHORT ||
                a->kind == TY_UINT || a->kind == TY_ULONG ||
                a->kind == TY_ULONGLONG);
  b_unsigned = (b->kind == TY_UCHAR || b->kind == TY_USHORT ||
                b->kind == TY_UINT || b->kind == TY_ULONG ||
                b->kind == TY_ULONGLONG);
...
# 8295 "zcc.c"
              ;
  if (ty->kind == TY_ARRAY)
    return type_decay_array(ty);
  if (ty->kind == TY_FUNC)
    return type_decay_func(ty);

  return ty;
}
# 8345 "zcc.c"
static void ast_walk_dispatch(Node *node, ZccASTVisitor fn, void *ctx,
                              int post) {
  if (!node || !fn)
    return;
  if (!post)
...
# 9236 "zcc.c" 3 4
               stderr
# 9236 "zcc.c"
                     , "[telem] fn=%s bb=%d used_regs=0x%02X src=%s\n",
...
# 9644 "zcc.c" 3 4
                 stderr
# 9644 "zcc.c"
                       , "zcc: codegen main local 'input_file'\n");
...
# 9652 "zcc.c" 3 4
                 stderr
# 9652 "zcc.c"
                       , "zcc: codegen main local 'output_file'\n");
...
void codegen_expr(Compiler *cc, Node *node) {
  ...
  case 105: {
    ...
    if (node->lhs && node->lhs->kind == 108 && node->lhs->sym &&
  ...
  case ND_COMPOUND_ASSIGN:
    ...
    if (node->lhs->kind == 108 && node->lhs->sym &&
        node->lhs->sym->assigned_reg) {
      ...
      case ND_ADD:
        if (is_pointer(node->lhs->type)) {
          ...
          if (esz > 1)
            do { int _e = (esz); if ((_e & (_e - 1)) == 0) fprintf((cc)->out, "    shlq $%d, %%r11\n", log2_of(_e)); else fprintf((cc)->out, "    imulq $%d, %%r11\n", _e); } while(0);
        }
  ...
  case ND_ADD: {
    ...
    if (node->lhs->type && is_pointer(node->lhs->type)) {
      ...
      if (esz > 1) {
        ...
        else do { int _e = (esz); if ((_e & (_e - 1)) == 0) fprintf((cc)->out, "    shlq $%d, %%r11\n", log2_of(_e)); else fprintf((cc)->out, "    imulq $%d, %%r11\n", _e); } while(0);
        char scale_str[32];
      ...
      if (esz > 1) {
        if (backend_ops) fprintf(cc->out, "    ldr r3, =%d\n    muls r0, r3, r0\n", esz);
        else do { int _e = (esz); if ((_e & (_e - 1)) == 0) fprintf((cc)->out, "    shlq $%d, %%rax\n", log2_of(_e)); else fprintf((cc)->out, "    imulq $%d, %%rax\n", _e); } while(0);
        char scale_str[32];
        sprintf(scale_str, "%d", esz);
        char *dst = ir_bridge_fresh_tmp();
...
static void compute_liveness(Node *n) {
  ...
  if (n->kind == 102 || n->kind == 103 || n->kind == ND_DO_WHILE) {
  ...
  if (n->kind == 110 && n->lhs && n->lhs->kind == 108 && n->lhs->sym) {
    n->lhs->sym->live_start = -1;
  }
  if (n->kind == 108 && n->sym && n->sym->is_local) {
...
# 13042 "zcc.c" 3 4
               stderr
# 13042 "zcc.c"
                     , "[ZCC-HOOK-02] FATAL: Register Manifold Stability check failed.\n");
        exit(1);
      }
    }
  }
...
# 13119 "zcc.c" 3 4
             stderr
# 13119 "zcc.c"
                   , "[telem] fn=%s used_regs=0x%02X src=%s\n",
...
# 13174 "zcc.c"
  ...
  int f_idx = 0;
  int gp_idx = 0;
  int stack_arg_off = 16;
  cc->sret_offset = 0;

  if (!backend_ops) {
  Type *ret_type = func->func_type ? func->func_type->ret : 
# 13184 "zcc.c" 3 4
                                                           ((void *)0)
# 13184 "zcc.c"
                                                               ;
...
static long long eval_const_expr_p4(Node *elem, int *ok) {
    ...
    if (elem->kind == 111) return eval_const_expr_p4(elem->lhs, ok);
        ...
        for (int i = 0; i < type->array_len; i++) {
            ...
            if (i < init_list->num_args) {
                ...
                if (elem->kind == ND_INIT_LIST) {
                    ...
                    while (elem && elem->kind == 111) elem = elem->lhs;
                    int const_ok = 1;
                    ...
                    } else if (elem->kind == 110 && elem->lhs && elem->lhs->kind == 108) {
                        if (elem_size == 4) fprintf(cc->out, "    .long %s\n", elem->lhs->name);
                        else fprintf(cc->out, "    .quad %s\n", elem->lhs->name);
                    } else if (elem->kind == 110 && elem->lhs && elem->lhs->kind == 109 && elem->lhs->lhs && elem->lhs->lhs->kind == ND_ADD && elem->lhs->lhs->lhs && elem->lhs->lhs->lhs->kind == 108 && elem->lhs->lhs->rhs && elem->lhs->lhs->rhs->kind == ND_NUM) {
                    ...
                    } else if (elem->kind == ND_ADD && elem->lhs && elem->lhs->kind == 108 && elem->rhs && elem->rhs->kind == ND_NUM) {
...
static void emit_global_var(Compiler *cc, Node *gvar) {
  ...
  if (gvar->initializer) {
    ...
    if (init && init->kind != ND_INIT_LIST && init->kind != ND_STR && init->kind != 110 && init->kind != ND_ADDR_LABEL && init->kind != ND_ADD) {
        int const_ok = 1;
    ...
    while (init && init->kind == 111) init = init->lhs;
    ...
    } else if (init->kind == 110 && init->lhs && init->lhs->kind == 108) {
      if (size == 4)
        fprintf(cc->out, "    .long %s\n", init->lhs->name);
      else
        fprintf(cc->out, "    .quad %s\n", init->lhs->name);
    } else if (init->kind == 110 && init->lhs && init->lhs->kind == 109 && init->lhs->lhs && init->lhs->lhs->kind == ND_ADD && init->lhs->lhs->lhs && init->lhs->lhs->lhs->kind == 108 && init->lhs->lhs->rhs && init->lhs->lhs->rhs->kind == ND_NUM) {
    ...
    } else if (init->kind == ND_ADD && init->lhs && init->lhs->kind == 108 && init->rhs && init->rhs->kind == ND_NUM) {
...
static void fold_constants(Compiler *cc, Node *node) {
  ...
  if (node->kind == 107 && node->num_args > 0) {
    int i;
    for (i = 0; i < node->num_args; i++)
      fold_constants(cc, node->args[i]);
  }
  if (node->kind == 100 && node->num_stmts > 0) {
    int i;
...
# 1 "forgezero_receipt.h" 1
# 43 "forgezero_receipt.h"
# 1 "ir_vuln_tag.h" 1
# 59 "ir_vuln_tag.h"
typedef enum {
    IR_VULN_NONE = 0,
    IR_VULN_UNTRUSTED_CALL = (1 << 0),
    IR_VULN_DELEGATE_CALL = (1 << 1),
    IR_VULN_STATIC_CALL = (1 << 2),
    IR_VULN_STATE_WRITE = (1 << 3),
    IR_VULN_PRIV_BOUNDARY = (1 << 4),
    IR_VULN_UNKNOWN = (1 << 5),
    IR_VULN_SELFDESTRUCT = (1 << 6),
    IR_VULN_CONTRACT_CREATE = (1 << 7),
    IR_VULN_EXEC_BARRIER = (1 << 8),
    IR_VULN_OOG = (1 << 9),

    IR_VULN_ALL_KNOWN = (1 << 10) - 1,
    IR_VULN_FLAG_MAX = (1 << 30)
} ir_vuln_tag_t;
# 83 "ir_vuln_tag.h"
...
# 44 "forgezero_receipt.h" 2
# 56 "forgezero_receipt.h"
typedef enum {
    FZR_MODE_DISABLED = 0,
    FZR_MODE_STDOUT = 1,
    FZR_MODE_FILE = 2
...
typedef enum {
    FZR_EVENT_AUDIT_FINDING = 0,
    FZR_EVENT_COMPILE_SUMMARY = 1,
    FZR_EVENT_SECURITY_TAG = 2
} fzr_event_kind_t;
...
# 85 "forgezero_receipt.h"
typedef struct {
    fzr_event_kind_t kind;
    fzr_severity_t severity;
    char vuln_tag_str[64];
    unsigned int vuln_tag_mask;
    char source_component[64];
    char target_id[128];
    unsigned int event_hash;
    char timestamp[32];
...
# 117 "forgezero_receipt.h"
void fzr_emitter_init(fzr_emitter_t *em,
                      fzr_mode_t mode,
                      FILE *fp,
                      int deterministic);
# 129 "forgezero_receipt.h"
...
static void peephole_optimize(char *filename) {
  ...
  if (!line_ptrs) {
    line_ptrs = (char **)malloc(3000000 * sizeof(char *));
  }
  line_buffer = (char *)malloc(file_size + 3000000 * 128);
  if (!line_buffer || !line_ptrs) {
    fclose(fp);
    return;
  }

  while (nlines < 3000000 && fgets(line_buffer + nlines * 128, 128, fp)) {
  ...
  for (i = 0; i < nlines; i++) {
    ...
    if (strstr(lp[i], "# ZCC_META_ARRAY")) {
      ...
      for (j = i - 1; j >= 0 && j >= i - 30; j--) {
          if (strstr(lp[j], "ret")) break;
          if (strstr(lp[j], "call ")) break;
          if (lp[j][0] != ' ' && lp[j][0] != '\t' && lp[j][0] != '.' && lp[j][0] != '#') break;
...
# 15251 "zcc.c"
  ...
  if (sculpt_sdf_mode) {
    ...
    zcc_sculpt_sdf(output_file ? output_file : "mesh.obj", 128);
    free(source);
    return 0;
  }
...
# 15628 "zcc.c" 3 4
               stderr
# 15628 "zcc.c"
                     , "[ZCC-HOOK-04] FATAL: IR Lowering Courtroom check failed.\\n");
        exit(1);
      }
    }
  }
...
# 16789 "zcc.c" 3 4
                      stdout
# 16789 "zcc.c"
                            , sym->name ? sym->name : "<anon>", RUST_DUMP_NAME_UNQUOTED);
...
# 17579 "zcc.c" 3 4
                      stdout
# 17579 "zcc.c"
                            , e->text, RUST_DUMP_NAME_UNQUOTED);
        fputc(')', 
# 17580 "zcc.c" 3 4
                  stdout
# 17580 "zcc.c"
...
# 17610 "zcc.c" 3 4
                      stdout
# 17610 "zcc.c"
                            , e->call_callee, RUST_DUMP_NAME_UNQUOTED);
        for (ai = 0; ai < e->call_arg_count; ai++) {
            fputc(' ', 
# 17612 "zcc.c" 3 4
                      stdout
...
# 17630 "zcc.c" 3 4
                              stdout
# 17630 "zcc.c"
                                    , st->name, RUST_DUMP_NAME_UNQUOTED);
                fputs(" <- ", 
# 17631 "zcc.c" 3 4
                             stdout
# 17631 "zcc.c"
...
# 17957 "zcc.c" 3 4
                          stdout
# 17957 "zcc.c"
                                , fn->name, RUST_DUMP_NAME_UNQUOTED);
            fputc('(', 
# 17958 "zcc.c" 3 4
                      stdout
# 17958 "zcc.c"
...
# 17961 "zcc.c" 3 4
                              stdout
# 17961 "zcc.c"
                                    , fn->param_names[pi], RUST_DUMP_NAME_UNQUOTED);
                fputs(":i32", 
# 17962 "zcc.c" 3 4
                             stdout
# 17962 "zcc.c"
...
# 19368 "zcc.c" 3 4
               stderr
# 19368 "zcc.c"
                     , "ir: out of memory allocating ir_node_t\n");
        exit(1);
    }
    return n;
}
...
# 19461 "zcc.c" 3 4
               stderr
# 19461 "zcc.c"
                     , "ir: out of memory allocating ir_module_t\n");
        exit(1);
    }
    return mod;
}
...
# 19475 "zcc.c" 3 4
               stderr
# 19475 "zcc.c"
                     , "ir: out of memory allocating ir_func_t\n");
        exit(1);
    }
