; ZCC FORMAL VERIFICATION LAYER: push_pop_replace AUTOMATED PROOF
(set-logic QF_ABV)
...
; pop rdi
(define-fun rdi_1 () (_ BitVec 64) (select mem_1 rsp_1))
(define-fun rsp_2 () (_ BitVec 64) (bvadd rsp_1 #x0000000000000008))

; --- POST-OPTIMIZATION STATE ---
; mov rax, rdi
(define-fun rdi_post () (_ BitVec 64) rax_0)
(define-fun rsp_post () (_ BitVec 64) rsp_0)

; --- EQUIVALENCE PROOF Target ---
; Proving final states of modified target registers are semantics-identical
(assert (not (and (= rdi_1 rdi_post) (= rsp_2 rsp_post))))
